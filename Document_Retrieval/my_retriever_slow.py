class Retrieve:
    ...
    def BinaryModel(self, query):
        ...
        for word_general in self.index:
            for key_doc in doc_index_qi_di:
                if key_doc in self.index[word_general]:
    ...
    def tfModel(self, query):
        ...
        doc_len_dict = {}
        for word_general in self.index:
            for key_doc in doc_index_tfqi_tfdi:
                if key_doc in self.index[word_general]:
    ...
    def tfidfModel(self, query):
        ...
        for word_general in self.index:
            ...
            for key_doc in tfidf_doc_query:
                if key_doc in self.index[word_general]:
